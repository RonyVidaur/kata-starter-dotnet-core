...
namespace Kata.Spec
{
    ...
    public class when_multiple_numbers_separated_by_new_line_and_comma
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_contains_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_contains_numbers_larger_than_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = _systemUnderTest.Add("1100,1,2,3"); };

        It should_only_sum_numbers_less_than_1001 = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_multiple_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();

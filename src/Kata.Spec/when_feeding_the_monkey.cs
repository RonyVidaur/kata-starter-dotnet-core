...
namespace Kata.Spec
{
    ...
    public class when_unknown_amount_of_numbers
    {
        ...
        It should_return_theSum = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_input_has_multiple_numbers_and_new_line_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_has_custom_single_char_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_with_custom_multi_character_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_has_multiple_single_character_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
